...
__all__ = ['createFileSystem', 'deleteFileSystem', 'getMountTargetForInstance', 'getMountUrl', 'createTag', 'getTag', 'nameInstance', 'nameVolume', 'getStatus', 'launchInstance', 'associateAddress', 'disassociateAddress', 'uploadLargeFile', 'getDevices', 'getNextAvailableDevice', 'getMySnapshots']
